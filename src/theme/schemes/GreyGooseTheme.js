...
const colors = {
  gradients: {
    blue1: 'linear-gradient(135deg, #6B73FF 0%, #2442AF 100%)',
    blue2: 'linear-gradient(135deg, #ABDCFF 0%, #0396FF 100%)',
    blue3: 'linear-gradient(127.55deg, #0396FF 3.73%, #0396FF 92.26%)',
    blue4: 'linear-gradient(-20deg, #2b5876 0%, #4e4376 100%)',
    blue5: 'linear-gradient(135deg, #97ABFF 10%, #0396FF 100%)',
  ...
  shadows: {
    ...
    primary:
      '0px 1px 4px rgba(128, 52, 804, 0.25), 0px 3px 12px 2px rgba(128, 52, 140, 0.35)',
    warning:
  ...
  layout: {
    ...
    sidebar: {
      ...
      dividerBg: '#2442AF',
      menuItemColor: '#2442AF',
      menuItemColorActive: themeColors.primary,
      menuItemBg: themeColors.white,
      menuItemBgActive: '#2442AF',
