          ...
          <Scrollbar>
            <SidebarContent>
              ...
              <Box mt={6}>
                ...
                >
                  {t('Múltiples métodos de autenticación incluidos')}
                </TypographyH1>
                <Box
                  sx={{
                    position: 'relative',
                ...
                >
                  {t(
                    'Elija entre JSON Web Token, Firebase, AWS Amplify o Auth0. La función regular de inicio de sesión/registro también está disponible.'
                  )}
                </Typography>
                <Typography
                  variant="subtitle1"
                ...
                <Typography variant="subtitle1">
                  {t(
                    'Solo toma unos segundos. Hay una sección de documentación que muestra cómo hacer exactamente eso'
                  )}
                  .{' '}
        ...
        <MainContent className='sapo'>
          ...
          >
            ...
            <Box textAlign="center">
                <img className='logoSipro' src='https://sipro.ingeal.com/assets/images/logosipro.png'></img>
              </Box>
              <Box textAlign="center">
                <Typography
                  variant="h2"
              ...
              {method !== 'Auth0' && (
                ...
                >
                  <Alert severity="warning">
                    Use <b>Usuario</b> y <b>Contraseña</b>
                  </Alert>
                </Tooltip>
              )}
            </Card>
