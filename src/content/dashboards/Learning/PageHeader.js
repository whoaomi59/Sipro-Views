          ...
          >
            <Box display="flex" alignItems="flex-start">
              ...
              <Box>
                ...
                >
                  {t('puntos de aprendizaje ganados')}
                </TypographySecondary>
                <TypographyPrimary
                  variant="h3"
                  sx={{
                ...
                >
                  {user.name}, {t('Hiciste un gran trabajo la semana pasada!')}
                </TypographyPrimary>
              </Box>
            </Box>
            <Stack
