    ...
    <BoxHighlights>
        ...
        <BoxLayoutsContent maxWidth="lg">
          ...
          >
            <Grid item xs={12} md={6}>
              ...
              >
                {t(
                  "Version 3.1 represents our biggest Sipro update. We've added a brand new layout with 100% reworked and improved components. Check out the live preview to see them in action."
                )}
              </TypographySubHeading>
            </Grid>
            <Grid item xs={12} md={6}>
      ...
      >
        ...
        >
          ...
          <Grid item xs={12} md={6}>
            <Box>
              ...
              >
                {t(
                  'With Sipro you can build apps for any purpose, from commerce to health or learning. We’ve got you covered!'
                )}
              </TypographySubHeading>
            </Box>
          </Grid>
        ...
        >
          <Grid item md={4}>
            <Box>
              ...
              >
                {t(
                  'Sipro comes integrated with 13 dashboards split across multiple popular product niches'
                )}
                :
              </TypographySubHeading>
        ...
        <Container maxWidth="sm">
          ...
          >
            {t(
              'Some of the features that make Sipro one of the best admin templates available today'
            )}
          </TypographyH2>
        </Container>
          ...
          >
            <Grid item xs={12} md={6}>
              ...
              <Typography variant="subtitle2">
                {t(
                  "We've built Sipro using modern industry standards all packed under MUI (Material-UI) components"
                )}
                .
              </Typography>
              <List
              ...
              >
                ...
                <ListItem>
                  ...
                  <ListItemText
                    primary={t(
                      'Progressive Web App Optimized. You can view Sipro offline on any screen size.'
                    )}
                  />
                </ListItem>
                <ListItem>
              ...
              <Grid container spacing={8}>
                ...
                >
                  <Box>
                    ...
                    >
                      {t(
                        "Seguir our documentation files to find out how to switch to a RTL layout. It's easy!"
                      )}
                    </Typography>
                    <Typography
                      variant="h4"
            ...
            >
              ...
              >
                ...
                >
                  ...
                  >
                    {t(
                      'Besid Figma files, Sipro also has included Sketch design files for certain pricing plans.'
                    )}
                  </Typography>
                </Box>
              </Box>
