...
import FullCalendario from '@fullcalendar/react';
...
const FullCalendarioWrapper = styled(Box)(
  ({ theme }) => `
...
function AplicacionesCalendario() {
  ...
  return (
    <>
      <Helmet>
        <title>Calendarioio - Aplicaciones</title>
      </Helmet>
      <PageTitleWrapper>
...
export default AplicacionesCalendario;
