              ...
              <Table>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell>{t('tiempo')}</TableCell>
                    <TableCell>{t('feca desde')}</TableCell>
                    <TableCell>{t('fecha hasta')}</TableCell>
                    <TableCell>{t('jefe/area')}</TableCell>
                    <TableCell>{t('dir.admin')}</TableCell>
                    <TableCell>{t('Actions')}</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {paginatedProducts.map((permiso) => {
                      ...
                      >
                        <TableCell padding="checkbox">
                          <Checkbox
                            ...
                            onChange={(event) =>
                              handleSelectOneProduct(event, permiso.id)
                            }
                        ...
                        <TableCell>{permiso.fechaDes}</TableCell>
                        <TableCell>{permiso.fechaHas}</TableCell>
                        <TableCell>
                        <Typography noWrap>
                            <Tooltip title={t(permiso.jefeAre)} arrow>
                        ...
                        <Typography align='center'>
                            <Tooltip title={t(permiso.dirAdmi)} align='center'>
                              <IconButton  color="primary"
                              >
                                <CheckIcon style={{ fontSize: 35}}/>
                              </IconButton>
                        ...
                        <TableCell align="center">
                          <Typography noWrap>
                            <Tooltip title={t('Imprimir')} arrow>
                              <IconButton  color="primary"
                              >
