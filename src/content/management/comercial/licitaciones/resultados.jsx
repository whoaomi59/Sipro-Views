...
const Tipo = (estados) => {
  ...
  return <label className={clas}>{text}</label>;
};
const Razon = (razon) =>{
  console.log(razon)
  const map = {
    null:{
      text:'NO',
      clss :'naranjaOpacity ty1 naranja'
    },
    1:{
      text:'SI',
      clss :'verdeOpacity ty1 verde'
    }
  }
  const {text,clss} = map[razon];
  return <label className={clss}>{text}</label>
}
                ...
                <Table>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>{t('#de licitacion')}</TableCell>
                      <TableCell>{t('entidad')}</TableCell>
                      ...
                      <TableCell>{t('objeto')}</TableCell>
                      <TableCell>{t('¿presentar?')}</TableCell>
                      <TableCell>{t('razon')}</TableCell>
                      <TableCell>{t('')}</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    {paginatedUsuarios.map(data => {
                      const isUsuariosSelected = selectedItems.includes(data.licinume);
                      return (
                        <TableRow hover key={data.licinume} selected={isUsuariosSelected}>
                          <TableCell>{data.licinume}</TableCell>
                          <TableCell>{data.licicodi}</TableCell>
                          <TableCell>{data.emprnomb}</TableCell>
                          <TableCell>{data.licitacionR}</TableCell>
                          <TableCell>{data.licifechlog}</TableCell>
                          <TableCell>{data.licifcier}</TableCell>
                          <TableCell>{data.licivalo}</TableCell>
                          <TableCell>{data.liciobje}</TableCell>
                          <TableCell>{data.liciobse}</TableCell>
                          <TableCell>{Razon(data.licilead)}</TableCell>
