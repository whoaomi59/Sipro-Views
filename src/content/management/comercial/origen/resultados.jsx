                ...
                <Table>
                  ...
                  <TableBody>
                    {paginatedUsuarios.map(data => {
                      const isUsuariosSelected = selectedItems.includes(data.orignume);
                      return (
                        <TableRow hover key={data.orignume} selected={isUsuariosSelected}>
                          <TableCell>{data.orignume}</TableCell>
                          <TableCell>{data.orignomb}</TableCell>
                          <TableCell>{Estado(data.orignelim)}</TableCell>
