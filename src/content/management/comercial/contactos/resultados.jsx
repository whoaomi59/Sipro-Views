...
const applyFilters = (data, query, filters) => {
  return data.filter((data) => {
    ...
    if (query) {
      const properties = ['contcodi', 'contnomb', 'emprnomb'];
                ...
                <Table>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>{t('#num')}</TableCell>
                      <TableCell>{t('detalles')}</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    {paginatedUsuarios.map(data => {
                      const isUsuariosSelected = selectedItems.includes(data.contcodi);
                      return (
                        <TableRow hover key={data.contcodi} selected={isUsuariosSelected}>
                          <TableCell>
                            <Typography variant="h5">{data.contnomb}</Typography>
                          </TableCell>
                          <TableCell>{data.emprnomb}</TableCell>
                          <TableCell>{data.contmail}</TableCell>
                          <TableCell align="center">{data.contcelu}</TableCell>
                          <TableCell>{data.contcodi}</TableCell>
                          <TableCell align="center">
                            <Iconoss data={data.  contcodi}/>
                          </TableCell>
                        </TableRow>
                      );
                    })}
