                ...
                <Table>
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell>{t('fech.ult.cot')}</TableCell>
                      <TableCell>{t('')}</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
                    {paginatedUsuarios.map(data => {
                      ...
                      return (
                        <TableRow hover key={data.emprcodi} selected={isUsuariosSelected}>
                          <TableCell>{data.emprcodi}</TableCell>
                          <TableCell>{data.emprnomb}</TableCell>
                          <TableCell>{data.usuanomb}</TableCell>
                          <TableCell>{data.solifech}</TableCell>
