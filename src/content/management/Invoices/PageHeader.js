    ...
    <>
      <Grid container justifyContent="space-between" alignItems="center">
        <Grid item>
          ...
          <Typography variant="subtitle2">
            {t('Todas las facturas recientes se pueden encontrar a continuación')}
          </Typography>
        </Grid>
        <Grid item>
          <Button
      ...
      >
        ...
        >
          ...
          <Typography variant="subtitle2">
            {t('Use este cuadro de diálogo modal para crear una nueva factura')}
          </Typography>
        </DialogTitle>
        <Formik
          initialValues={{
          ...
          validationSchema={Yup.object().shape({
            number: Yup.string()
              .max(255)
              .required(t('El campo del número de factura es obligatorio'))
          })}
          onSubmit={async (
            _values,
            ...
            <form onSubmit={handleSubmit}>
                ...
                <Grid container spacing={3}>
                  <Grid item xs={12} md={6}>
                    ...
                    <TextField
                      ...
                      name="number"
                      placeholder={t('Número de factura aquí...')}
                      onBlur={handleBlur}
                    ...
                    <Autocomplete
                      ...
                      renderInput={(params) => (
                        <TextField
                          ...
                          placeholder={t('Seleccionar destinatario de la factura ...')}
                        />
                      )}
                  ...
                  <Grid item xs={12} md={6}>
                    ...
                    <DatePicker
                      ...
                      renderInput={(params) => (
                        <TextField
                          fullWidth
                          placeholder={t('Seleccione fecha...')}
                          {...params}
                        />
                      )}
                    />
              ...
              <Box px={3} pt={3}>
                <TextField
                  ...
                  multiline
                  placeholder={t(
                    'Escriba aquí cualquier información adicional que pueda tener...'
                  )}
                  fullWidth
                  minRows={3}
                  maxRows={8}
