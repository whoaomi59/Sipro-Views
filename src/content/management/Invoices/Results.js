...
const Results = ({ invoices }) => {
  ...
  const handleDeleteCompleted = () => {
    ...
    enqueueSnackbar(t('Eliminar acción completada con éxito'), {
      variant: 'success',
      anchorOrigin: {
        vertical: 'top',
        horizontal: 'right'
        ...
        <Grid alignItems="center" container spacing={3}>
          <Grid item xs={12} lg={7} md={6}>
            <TextField
              ...
              placeholder={t('Buscar facturas por nombre de cliente...')}
              value={query}
              fullWidth
              variant="outlined"
            />
      ...
      <Card>
          ...
          {!selectedBulkActions && (
            ...
            >
              <Box>
                ...
                <b>{paginatedInvoices.length}</b> <b>{t('facturas')}</b>
              </Box>
              <TablePagination
                component="div"
        ...
        {paginatedInvoices.length === 0 ? (
          <Typography
            ...
            align="center"
          >
            {t("No pudimos encontrar ninguna factura que coincida con sus criterios de búsqueda")}
          </Typography>
        ) : (
          <>
            <TableContainer>
