                ...
                <Grid item xs={12}>
                  ...
                  >
                    <Box p={3}>
                      ...
                      <Typography variant="h3">{t('Ingreso')}</Typography>
                    </Box>
                    <CardActions>
                ...
                <Grid item xs={12}>
                  ...
                  >
                    <Box p={3}>
                      ...
                      <Typography variant="h3">{t('Gastos')}</Typography>
                    </Box>
                    <CardActions>
                      <IconButton size="small" color="primary">
                        <MoreHorizTwoToneIcon />
        ...
        >
          <Box p={3}>
            <Box>
              ...
              >
                {t("Verifique cómo le está yendo financieramente para el mes actual")}
              </Typography>
            </Box>
          </Box>
          <Divider />
